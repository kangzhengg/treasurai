...
export function LiveIntelligencePanel({ isOpen, onClose }: LiveIntelligencePanelProps) {
  const fxRates = [
    {
      pair: 'USD/MYR',
      rate: 4.7215,
  ...
  return (
    <div className="fixed right-6 top-20 w-80 bg-[#0d1117] border border-slate-700 rounded-2xl shadow-2xl flex flex-col overflow-hidden z-50 animate-slide-in">
      <div className="p-4 border-b border-slate-800 flex items-center justify-between bg-slate-900/50">
        <h3 className="text-sm font-semibold text-slate-200">Live Intelligence</h3>
        <button
          onClick={onClose}
      ...
      <div className="flex-1 overflow-y-auto scrollbar-custom max-h-[calc(100vh-12rem)]">
